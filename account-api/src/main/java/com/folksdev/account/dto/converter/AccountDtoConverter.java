...
/***
 * Converter class'ini ben yaziyorum, test edilmesi daha rahat oluyor.
 * Normalde internette ornekleri var, copy paste yapilabilir ama koltin ile tam entegre calismiyor
 */
@Component
